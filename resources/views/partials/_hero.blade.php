<div class="flex flex-col sm:flex-row bg-gray-200">
  <div class="sm:w-5/12 text-gray-700 bg-gray-400 px-4 py-2 m-2">
  ...
  <div class="sm:w-4/12 text-gray-700 bg-gray-400 px-4 py-2 m-2">
    <div class="flex flex-col">
  ...
  <div class="sm:w-3/12 text-gray-700 bg-gray-400 px-4 py-2 m-2">
    <div class="flex flex-col">
      <div>
        <img src="https://picsum.photos/400/200" alt="" class="w-100">
      </div>
